...
declare const Api: (props: Props$7 & MetadataProps) => {
  ...
  doc: () => string
  path: () => string
  addLink: (link: { title: string; url: string; icon: string }) => void
}
...
declare const serviceV1Schema: z.ZodObject<
  z.extendShape<
    {
      $schema: z.ZodString
      name: z.ZodString
...
declare const websiteV1Schema: z.ZodObject<
  z.extendShape<
    {
      $schema: z.ZodString
      name: z.ZodString
...
declare const documentationV1Schema: z.ZodObject<
  z.extendShape<
    {
      $schema: z.ZodString
      name: z.ZodString
...
declare const schema: z.ZodUnion<
  [
    z.ZodObject<
      z.extendShape<
        {
