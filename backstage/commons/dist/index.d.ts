...
declare const Api: (props: Props$6 & MetadataProps) => {
    get: () => {
...
declare const Deployment: (props: Props$5 & MetadataProps) => {
    get: () => {
...
declare const Service: (props: Props$4 & MetadataProps) => {
    /**
...
declare const System: (props: Props$3 & MetadataProps) => {
    get: () => {
        apiVersion: "backstage.io/v1alpha1";
        metadata: {
            name: string;
...
declare const Team: (props: Props$2 & MetadataProps) => {
    get: () => {
        apiVersion: "backstage.io/v1alpha1";
        metadata: {
            name: string;
...
declare const User: (props: Props$1 & MetadataProps) => {
    get: () => {
        apiVersion: "backstage.io/v1alpha1";
        metadata: {
            name: string;
...
declare const Website: (props: Props & MetadataProps) => {
    get: () => {
        apiVersion: "backstage.io/v1alpha1";
        metadata: {
            name: string;
...
export { Api, ApiType, BaseEntity, Deployment, DeploymentType, Organization, OrganizationType, SchemaType, Service, ServiceType, ServiceV1SchemaType, System, SystemType, Team, TeamType, User, UserType, Website, WebsiteType, WebsiteV1SchemaType, schema, serviceV1Schema, websiteV1Schema };
